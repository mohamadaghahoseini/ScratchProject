   ...
   // SDL_Surface* tempSurface = IMG_Load("")
    ...
    std:: vector<AllTabButtons> tabButtons= {
            {TAB_GENERAL,true ,  {     {CLOSE_BUTTON, SDL_Rect{app.W-app.W/30,0,app.W/30,app.H/25}},
                                       ...
                                       {SETTING_BUTTON, SDL_Rect{app.W*2/15,0,app.W/15,app.H/25},{3*iconSize,0,iconSize,iconSize}},
                                       {EDIT_BUTTON, SDL_Rect{app.W*1/15,0,app.W/15,app.H/25},{4*iconSize,0,iconSize,iconSize}},
                                       {FILE_BUTTON, SDL_Rect{0,0,app.W/15,app.H/25},{5*iconSize,0,iconSize,iconSize}},
            }
            }
    };
...
void RenderTextureGeneral(std::vector<ButtonRect> buttons,AppState &app,ThemeGeneralTab &color,TabTexture& tabTexture,ButtonTextures &buttonTextures){
    ...
    SDL_SetRenderDrawColor(app.renderer,45,48,48,225);
...
//void RenderGeneralTab(std::vector<ButtonRect> buttons, AppState &app, ThemeGeneralTab &color);{
